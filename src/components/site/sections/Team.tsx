      ...
      <div className="container-lux grid gap-14 lg:grid-cols-2 lg:gap-20 items-center">
        <div>
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 max-w-md">
            {["Dra. Mirian Gomes", "Dra. Hulda Sebastião", "Dr. Aldo Simão", "Dr. José Luzolo"].map((n) => (
        ...
        <motion.div {...fadeUp} className="relative">
          ...
          <div className="relative rounded-3xl overflow-hidden border border-border/60 bg-card aspect-[4/3]">
            <img src={teamImg2} alt="Equipa da Clínica Dental Gomes" loading="lazy" className="h-full w-full object-cover" />
          </div>
        </motion.div>
      </div>
    </section>
