      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="rounded-md bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:brightness-110"
          >
            Tentar novamente
          </button>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Clínica Dental Gomes" },
      { name: "theme-color", content: "#141311" },
      { property: "og:title", content: TITLE },
      { property: "og:description", content: DESCRIPTION },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Clínica Dental Gomes" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          address: {
            "@type": "PostalAddress",
            streetAddress: "Projecto Morar, ao lado da escola Comandante Loy",
            addressLocality: "Viana, Luanda Sul",
            addressCountry: "AO",
          },
          telephone: "+244927917779",
          email: "Clinicadentalgomes@gmail.com",
          priceRange: "$$$",
          founder: { "@type": "Person", name: "Dra. Mirian Gomes" },
        }),
      },
    ],
  }),
